...
public class AppTest 
{
	...
	public void verifyCheckout() throws IOException {
		...
		WebElement addtoCart = driver.findElement(By.xpath("/html/body/div/div[2]/div/div[2]/div/div[1]/ul[1]/li[2]/div/div[1]/div/a[1]/img"));
		addtoCart.click();
		
		new WebDriverWait(driver, 5).until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/div/div[2]/div/div[3]/div/div/div/div[4]/form/div/div[3]/div[1]/p/button")));
		title = driver.getTitle();
		
		if (title.equals("Blouse - My Store")) {
			// report the test as a pass
			
			test.log(LogStatus.PASS, "verify Title of the product page");
		} else {
			test.log(LogStatus.FAIL, "verify Title of the product page");
		}
		
		WebElement addtoCartpage = driver.findElement(By.xpath("/html/body/div/div[2]/div/div[3]/div/div/div/div[4]/form/div/div[3]/div[1]/p/button"));
		addtoCartpage.click();
		
		new WebDriverWait(driver, 5).until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/div/div[1]/header/div[3]/div/div/div[4]/div[1]/div[2]/div[4]/a/span")));
		
		WebElement gotocheckout = driver.findElement(By.xpath("/html/body/div/div[1]/header/div[3]/div/div/div[4]/div[1]/div[2]/div[4]/a/span"));
		gotocheckout.click();
